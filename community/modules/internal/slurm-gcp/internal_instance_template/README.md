...
| [google_compute_snapshot.munge_snapshot](https://registry.terraform.io/providers/hashicorp/google/latest/docs/data-sources/compute_snapshot) | data source |
...
| <a name="input_munge_snapshot"></a> [munge\_snapshot](#input\_munge\_snapshot) | The snapshot name of the disk that contains the munge key, only used in hybrid mode. | `string` | `null` | no |
